...
namespace idefny.Migrations
{
    ...
    [Migration("20241221190626_AddAvailableForBorrowAndIsAvailableForBorrowToBooks")]
    partial class AddAvailableForBorrowAndIsAvailableForBorrowToBooks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("idefny.Models.Borrow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("idefny.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("idefny.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("idefny.Models.OrderItem", b =>
                {
                    ...
                    b.HasOne("idefny.Models.Order", "Order")
                        .WithMany("OrderItems")
